...
const obtenerGanador = (zona) => obtenerClasificadosZona(zona, 1);
  ...
  <label className="text-[10px] font-black uppercase text-amber-500 block mb-2 ml-2">
    Categoría de Trabajo Actual
  </label>
  <select 
    value={categoriaSeleccionada}
    onChange={(e) => manejarCambioCategoria(e.target.value)}
    className="w-full bg-slate-950 border border-slate-800 p-3 rounded-2xl text-xs font-bold text-white outline-none focus:border-amber-500 cursor-pointer"
  >
    {categorias.map(cat => (
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-[3rem] p-8 space-y-6 overflow-hidden animate-in fade-in duration-700">
            <div className="text-center mb-8">
              <h2 className="text-xl font-black uppercase italic text-white tracking-tighter">
                Estructura Completa del Torneo <span className="text-blue-500">nc-s1125</span>
              </h2>
            </div>
