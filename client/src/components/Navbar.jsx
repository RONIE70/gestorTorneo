...
<Link to="/" className="flex items-center gap-4 flex-shrink-0 group" onClick={() => setMenuAbierto(false)}>
  ...
  <div className="flex flex-col">
    ...
    <span className="text-primary text-[9px] font-bold tracking-[0.4em] text-slate-500 uppercase mt-1">
      Gestor de Torneo
    </span>
  </div>
</Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {userSession ? (
            ...
            <Link 
              to="/login"
              className="text-primary hover:bg-primary-500 text-white text-[10px] font-black px-6 py-2.5 rounded-xl uppercase shadow-xl transition-all active:scale-95"
            >
              Ingresar
            </Link>
          )}
        ...
        <div className="md:hidden mt-4 pt-4 border-t border-slate-800 flex flex-col gap-4 animate-in fade-in slide-in-from-top-4 duration-200">
          ...
          {userSession ? (
            ...
            <Link 
              to="/login" 
              onClick={() => setMenuAbierto(false)} 
              className="text-primary text-white text-center py-4 rounded-xl font-black uppercase text-xs shadow-lg"
            >
              Ingresar al Portal
            </Link>
          )}
